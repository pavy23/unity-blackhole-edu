...
namespace MilkyWay
{
    ...
    public class NebulaProto : MonoBehaviour
    {
        ...
        public static readonly Preset[] Presets =
        {
            ...
            new Preset { name = "Supernova Remnant (Crab)", type = 3f, brightness = 0.4f,
                color1 = new Color(2.3f, 0.95f, 0.35f), color2 = new Color(0.4f, 1.6f, 1.0f),
                radius = 7f, density = 1.2f, noiseScale = 0.5f, filament = 1.5f,
