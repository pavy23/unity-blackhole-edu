    ...
    public class MilkyWayControls : MonoBehaviour
    {
        ...
        void UpdateHelpText()
        {
            ...
            help.text = Loc.T(
                ...
                + Key("우클릭") + "회전   " + Key("휠") + "줌   " + Key("N/B") + "투어 이동   " + Key("M") + "소리   " + Key("K") + "언어   " + Key("H") + "도움말",
