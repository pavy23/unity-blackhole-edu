...
namespace MilkyWay
{
    ...
    public class NebulaTour : MonoBehaviour
    {
        ...
        static readonly Step[] Steps =
        {
            ...
            new Step { specimen = 4, title = "5. 흩어지는 가스 — 신의 눈", titleEn = "5. Gas Scattering — the Eye of God",
                titleJa = "5. 散りゆくガス — 神の目", titleZh = "5. 散逸的气体——上帝之眼" },
            new Step { specimen = 5, title = "6. 무거운 별의 폭발", titleEn = "6. The Explosion of a Massive Star",
                titleJa = "6. 重い星の爆発", titleZh = "6. 大质量恒星的爆发" },
            new Step { specimen = 6, title = "7. 살아남은 자들, 그리고 순환", titleEn = "7. The Survivors, and the Cycle",
                titleJa = "7. 生き残りたち、そして循環", titleZh = "7. 幸存者，以及循环" },
        };
        ...
        public static readonly string[] NarrationLines =
        {
            ...
            "긴 삶의 끝, 태양 정도의 별은 조용히 죽습니다. 연료가 떨어진 별이 바깥층을 부드럽게 벗어던지면, 고리 성운처럼 아름다운 껍질이 부풀어 오릅니다. 가운데 남은 뜨거운 핵 — 백색왜성 — 이 그 가스를 달궈 빛나게 합니다.",
            "나선 성운은 같은 죽음을 훨씬 가까이서 정면으로 본 모습입니다. ‘신의 눈’이라 불리죠. 안쪽 푸른 고리는 산소, 바깥 붉은 테두리는 수소입니다. 이렇게 흩어진 가스는 다시 우주 공간으로 퍼져, 언젠가 새 별의 재료가 됩니다.",
        ...
        public static readonly string[] NarrationLinesEn =
        {
            ...
            "At the end of a long life, a star like the Sun dies quietly. Out of fuel, it gently sheds its outer layers, and a beautiful shell swells outward — like the Ring Nebula. The hot core left behind — a white dwarf — lights the gas up.",
            "The Helix Nebula is the same kind of death, seen much closer and face-on — often called the Eye of God. The inner blue ring is oxygen, the outer red rim hydrogen. This scattered gas drifts back into space, one day to become the material of new stars.",
        ...
        public static readonly string[] NarrationLinesJa =
        {
            ...
            "長い一生の終わり、太陽ほどの星は静かに死にます。燃料が尽きた星が外層をそっと脱ぎ捨てると、環状星雲のような美しい殻が膨らみます。中心に残った高温の核 — 白色矮星 — がそのガスを照らします。",
            "らせん星雲は同じ死を、はるかに近くから正面で見た姿です。「神の目」とも呼ばれます。内側の青い環は酸素、外側の赤い縁は水素。こうして散らばったガスは再び宇宙空間へ広がり、いつか新しい星の材料になります。",
        ...
        public static readonly string[] NarrationLinesZh =
        {
            ...
            "在漫长一生的尽头，像太阳这样的恒星静静地死去。燃料耗尽后，它轻轻抛出外层，一层美丽的壳膨胀开来——就像环状星云。残留在中心的炽热核心——白矮星——点亮了这些气体。",
            "螺旋星云是同样的死亡，只是从更近处正面观看——常被称为“上帝之眼”。内侧的蓝环是氧，外侧的红边是氢。这些散逸的气体重新飘回太空，终有一天会成为新恒星的原料。",
